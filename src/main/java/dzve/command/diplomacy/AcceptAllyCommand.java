...
public class AcceptAllyCommand extends AbstractPlayerCommand {
    ...
    @Nonnull
    private final RequiredArg<String> groupName = withRequiredArg("group", "Name of the group to accept alliance from",
            ArgTypes.STRING);
    ...
    protected void execute(@Nonnull CommandContext ctx, @Nonnull Store<EntityStore> store,
        ...
        groupService.getDiplomacyService().acceptAllyRequest(player, groupName.get(ctx));
    }
}
