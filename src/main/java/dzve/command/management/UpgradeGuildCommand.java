...
public class UpgradeGuildCommand extends AbstractPlayerCommand {
    private final GroupService groupService;

    public UpgradeGuildCommand(GroupService groupService) {
        super("upgrade", "Upgrade your guild level");
    ...
    protected void execute(@Nonnull CommandContext ctx, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref, @Nonnull PlayerRef player, @Nonnull World world) {
        groupService.upgradeGuild(player);
    }
}